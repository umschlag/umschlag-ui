...
import (
	...
	"github.com/umschlag/umschlag-ui/pkg/middleware/requests"
	...
	return &cli.Command{
		...
		Flags: []cli.Flag{
			&cli.StringFlag{
				...
				EnvVars:     []string{"UMSCHLAG_UI_HOST"},
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"UMSCHLAG_UI_ADDR"},
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"UMSCHLAG_UI_ROOT"},
			...
			&cli.BoolFlag{
				...
				EnvVars:     []string{"UMSCHLAG_UI_PPROF"},
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"UMSCHLAG_UI_CERT"},
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"UMSCHLAG_UI_KEY"},
			...
			&cli.BoolFlag{
				...
				EnvVars:     []string{"UMSCHLAG_UI_LETSENCRYPT"},
			...
			&cli.StringFlag{
				...
				EnvVars:     []string{"UMSCHLAG_UI_ENDPOINT"},
