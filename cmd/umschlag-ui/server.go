...
func serverFlags(cfg *config.Config) []cli.Flag {
	return []cli.Flag{
		&cli.StringFlag{
			...
			EnvVars:     []string{"UMSCHLAG_UI_METRICS_ADDR"},
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{"UMSCHLAG_UI_METRICS_TOKEN"},
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{"UMSCHLAG_UI_SERVER_ADDR"},
		...
		&cli.BoolFlag{
			...
			EnvVars:     []string{"UMSCHLAG_UI_SERVER_PPROF"},
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{"UMSCHLAG_UI_SERVER_HOST"},
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{"UMSCHLAG_UI_SERVER_ROOT"},
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{"UMSCHLAG_UI_STATIC_PATH"},
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{"UMSCHLAG_UI_API_ENDPOINT"},
