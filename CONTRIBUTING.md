...
Welcome! Our community focuses on helping others and making Umschlag the best it
...
If unique, [open an issue](https://github.com/umschlag/umschlag-ui/issues)
and answer the questions so we can understand and reproduce the problematic
behavior.

The burden is on you to convince us that it is actually a bug in Umschlag. This
...
Please be kind, remember that Umschlag comes at no cost to you, and you're
getting free help.
...
resolving issues as you are able to. Thanks for making Umschlag amazing!
...
umschlag@webhippie.de. If it's not a big deal, a pull request will probably be
faster.


## Thank you

Thanks for your help! Umschlag would not be what it is today without your
contributions.
